...
const Footer = () => {
    return (
        <footer className="px-4 divide-y bg-[#00afb9] text-white dark:bg-blue-100/50">
            <div className="container flex flex-col justify-between py-10 mx-auto space-y-8 lg:flex-row lg:space-y-0">
                <div className="lg:w-1/3">
                    <Link to='/' className="flex  justify-center items-center space-x-3 lg:justify-start">
                        <div className=" rounded-full ">
                            <img className='h-[50px] md:h-[70px] ' src="/logo.png" alt="" />
                        </div>
                        <span className='text-2xl font-bold'>Medicine Shop</span>

                    </Link>
                </div>
                <div className="grid grid-cols-2 text-sm gap-x-3 gap-y-8 lg:w-2/3 sm:grid-cols-4 ml-13 md:ml-0">
