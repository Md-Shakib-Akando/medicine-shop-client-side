        ...
        <div className='max-w-11/12 mx-auto my-15'>
            ...
            <div className='grid grid-cols-1 md:grid-cols-2  xl:grid-cols-4 gap-6'>
                {latestMedicine.map(med => (
                    <div
                        key={med._id}
                        className="card dark:bg-base-200 shadow-sm w-full h-full group relative overflow-hidden transition duration-500 "
                    >
                            ...
                            <div className='flex justify-between items-start gap-2'>
                                ...
                                <div className='text-right w-1/3'>
                                    <p className="text-gray-900 dark:text-base-content text-[17px] font-bold">
                                        ...
                                        <span className="text-[15px] line-through text-gray-500 ml-1 dark:text-base-content">${med.price}</span>
                                    </p>
                                </div>
                            </div>
